...
.. code-block:: bash
   ...
   host> ls -l path/to/dreamdevbox/cfg/ | grep 'php-ini'
...
``dreamdevbox-php.ini-default`` and ``dreamdevbox-php.ini-xdebug``.

**dreamdevbox-php.ini-default**
